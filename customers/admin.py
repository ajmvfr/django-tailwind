...
class CustomerResource(resources.ModelResource):
    ...
    def dehydrate_additional_info(self, obj):  #the name of the function to reformat is very specific
        if len(obj.additional_info) == 0:
            return "-"
        elif len(obj.additional_info) < 5:
            return obj.additional_info
        else:
            txt_list = obj.additional_info.split(" ")[:5] #this returns the first 5 words
